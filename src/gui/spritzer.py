...
TOP_BORDER_IMG = f'{IMAGES_DIR}/top_border_gr.png'
BOTTOM_BORDER_IMG = f'{IMAGES_DIR}/bottom_border_gr.png'

TMP_INPUT = '/tmp/spritz.txt'
BOOKMARKS_FILE = f'{DATA_DIR}/bookmarks.pkl'
#                                         ___   ___
#     //   ) )  //   / / /__  ___/ /__  ___/ / /    /|    / / //   ) )  //   ) )
#    ((        //____      / /       / /    / /    //|   / / //        ((
#      \\     / ____      / /       / /    / /    // |  / / //  ____     \\
...
WHITE = 'white'
TEXT_COLOR = '#454745'
BAR_COLOR = '#6E9378'  # Highlight color for middle char/indicators.
HIGHLIGHT_BG = '#757575'  # Unclear.
SLIDER_BG = '#94B493'  # WPM Slider anchor inactive color.
SLIDER_HIGH_BG = "#87A286"  # WPM Slider anchor "active" color.
TROUGH_COLOR = '#131313'  # Main background color.
WPM_TROUGH = "#6E9378"  # Color of the area under the sliding part of the wpm slider.
...
class SpritzApp():
    ...
    def __init__(self, words_list, top=None, start_idx=0,
        ...
        top.resizable(1,  1)
        top.title("Spritzer")
        top.configure(background=TROUGH_COLOR)
        top.configure(cursor="arrow")
        top.configure(highlightbackground=HIGHLIGHT_BG)
        ...
        self.text_frame.configure(background=TROUGH_COLOR)
        self.text_frame.configure(highlightbackground=TROUGH_COLOR)
        ...
        self.left_wd_frame.configure(background=TROUGH_COLOR)
        ...
        self.left_wd_label.configure(activebackground=TROUGH_COLOR)
        self.left_wd_label.configure(activeforeground=TEXT_COLOR)
        self.left_wd_label.configure(activeforeground=TROUGH_COLOR)
        self.left_wd_label.configure(anchor='e')
        self.left_wd_label.configure(background=TROUGH_COLOR)
        ...
        self.left_wd_label.configure(foreground=TEXT_COLOR)
        ...
        self.right_wd_frame.configure(background=TROUGH_COLOR)
        ...
        self.right_wd_label.configure(activebackground=TROUGH_COLOR)
        self.right_wd_label.configure(activeforeground=TEXT_COLOR)
        self.right_wd_label.configure(anchor='w')
        self.right_wd_label.configure(background=TROUGH_COLOR)
        self.right_wd_label.configure(borderwidth="0")
        self.right_wd_label.configure(
                font="-family {Courier 10 Pitch} -size 24")
        self.right_wd_label.configure(foreground=TEXT_COLOR)
        ...
        self.top_border_label.configure(activebackground=TROUGH_COLOR)
        self.top_border_label.configure(activeforeground=BLACK)
        self.top_border_label.configure(anchor='center')
        self.top_border_label.configure(background=TROUGH_COLOR)
        ...
        self.bottom_border_label.configure(activebackground=TROUGH_COLOR)
        self.bottom_border_label.configure(activeforeground=BLACK)
        self.bottom_border_label.configure(anchor='center')
        self.bottom_border_label.configure(background=TROUGH_COLOR)
        ...
        self.controls_frame.configure(background=TROUGH_COLOR)
        ...
        self.prev_wd_btn.configure(background=TROUGH_COLOR)
        ...
        self.play_pause_btn.configure(background=TROUGH_COLOR)
        ...
        self.next_wd_btn.configure(background=TROUGH_COLOR)
        ...
        self.wpm_slider.configure(activebackground=SLIDER_BG)
        self.wpm_slider.configure(background=TROUGH_COLOR)
        self.wpm_slider.configure(highlightbackground=SLIDER_HIGH_BG)
        self.wpm_slider.configure(length="325")
        self.wpm_slider.configure(orient="horizontal")
        self.wpm_slider.configure(troughcolor=WPM_TROUGH)
        ...
        self.idx_label.configure(activebackground=TROUGH_COLOR)
        self.idx_label.configure(activeforeground=BLACK)
        self.idx_label.configure(anchor='e')
        self.idx_label.configure(background=TROUGH_COLOR)
